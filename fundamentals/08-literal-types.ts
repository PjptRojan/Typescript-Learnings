...
let pageSize: 10 | 15 | 20 = 10; // if we know that a variable can only have certain types of values in it. we can implement the literal types.

pageSize = 15; // now the pageSize variable cannot have values other than 10, 15 or 20.

let courseStatus: 'draft' | 'published' | 'unpublished' | 'archive' = 'draft';
